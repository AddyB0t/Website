...
const sampleChapters = {
  "6": [
    { id: 1, title: "Number System", exercises: ["Exercise 1A", "Exercise 1B", "Exercise 1C"] },
    { id: 2, title: "Factors and Multiples", exercises: ["Exercise 2A", "Exercise 2B"] },
    { id: 3, title: "Fractions", exercises: ["Exercise 3A", "Exercise 3B", "Exercise 3C"] },
  ],
  "7": [
    { id: 1, title: "Integers", exercises: ["Exercise 1A", "Exercise 1B"] },
    { id: 2, title: "Fractions", exercises: ["Exercise 2A", "Exercise 2B", "Exercise 2C"] },
    { id: 3, title: "Decimals", exercises: ["Exercise 3A", "Exercise 3B"] },
  ],
...
const sampleQuestions = {
  "Exercise 1A": [
    { id: 1, text: "Write the following in Roman numerals: (i) 49 (ii) 95 (iii) 427 (iv) 999" },
    { id: 2, text: "Express the following in Hindu-Arabic numerals: (i) LXIV (ii) XCIX (iii) CDLXXVIII" },
    { id: 3, text: "Find the place value and face value of 7 in 5,479,283." },
  ],
  "Exercise 1B": [
    { id: 1, text: "Find the difference between the place values of two 5's in 5,358,575." },
    { id: 2, text: "What must be added to 12,791 to get 28,000?" },
  ],
  // Add more exercises as needed
};

export default function RSAggarwalMathematics() {
    ...
    try {
      ...
      const response = await fetch("/api/generate-answer", {
        ...
        body: JSON.stringify({
          ...
          book: `R.S. Aggarwal Mathematics Class ${className}`,
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-grow py-8 md:py-12 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-light text-gray-800 mb-2">R.S. Aggarwal Mathematics {getClassName(className)}</h1>
