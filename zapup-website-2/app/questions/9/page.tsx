...
export default function Class9QuestionsPage() {
  ...
  const subjects = [
    {
      ...
      description: 'Number Systems, Polynomials, Coordinate Geometry, Statistics',
    ...
    },
    {
      ...
      description: 'Matter, Living World, Motion, Work and Energy, Sound',
    ...
    },
    {
      ...
      description: 'French Revolution, Nazism, Physical Features, Democracy',
    ...
    },
    {
      ...
      description: 'Literature, Language Skills, Creative Expression',
    ...
    },
    {
      ...
      description: 'साहित्यिक विधाएं, भाषा कौशल, रचनात्मक अभिव्यक्ति',
  ...
  const handleSubjectClick = (subjectId: string, available: boolean) => {
    if (available) {
      router.push(`/questions/9/${subjectId}`)
    }
  }
      ...
      <div className="p-6 max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 flex items-center space-x-3">
            ...
            <span>Class 9 Questions</span>
          </h1>
          <p className="text-gray-600 mt-2">
            Prepare for board exams with Class 9 comprehensive questions. Questions coming soon!
          </p>
        </div>
