...
import { Brain, BookOpen, ChevronRight, Calculator, Atom, Globe, Languages, Star, Trophy, Clock, GraduationCap } from 'lucide-react'
import Link from 'next/link'

export default function Class10QuestionsPage() {
  const router = useRouter()
  
  // Define subjects available for Class 10
  const subjects = [
    {
      id: 'mathematics',
      name: 'Mathematics',
      icon: <Calculator className="w-6 h-6" />,
      description: 'Real Numbers, Polynomials, Trigonometry, Coordinate Geometry',
    ...
    },
    {
      ...
      description: 'Light, Electricity, Life Processes, Natural Resource Management',
    ...
    },
    {
      ...
      description: 'Nationalism, Economics, Resources, Democratic Politics',
    ...
    },
    {
      ...
      description: 'Literature, Language and Literature, Writing Skills',
    ...
    },
    {
      ...
      description: 'क्षितिज, कृतिका, व्याकरण, लेखन कौशल',
  ...
  const handleSubjectClick = (subjectId: string, available: boolean) => {
    if (available) {
      router.push(`/questions/10/${subjectId}`)
    }
  }
      ...
      <div className="p-6 max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 flex items-center space-x-3">
            ...
            <span>Class 10 Questions</span>
          </h1>
          <p className="text-gray-600 mt-2">
            Excel in your board exams with comprehensive Class 10 questions. Questions coming soon!
          </p>
        </div>
